...
(async () => {
  ...
  try {
    ...
    fs.mkdirSync(path.dirname(cfg.paths.members), { recursive: true });
    fs.writeFileSync(cfg.paths.members, JSON.stringify({ fetchedAt: new Date().toISOString(), groups }, null, 2));
